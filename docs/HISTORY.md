...
- Added new Modbus client function:
  ...
  - 23 (0x17): Read/Write Multiple Regiters.
...
- Safely close client connection in destructor of TIdModbusClient.
...
- Fix: Make response error handling in TIdModbusClient thread safe.
